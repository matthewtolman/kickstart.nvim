...
require('lazy').setup({
  ...
  -- For session remembering
  'rmagatti/auto-session',

  -- "gc" to comment visual regions/lines
  { 'numToStr/Comment.nvim', opts = {} },

  -- For column width indicator
  {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader><leader>t', builtin.buffers, { desc = '[ ] Find existing buffers' })
